...
public class AReplyCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length < 2) {
            ...
            Object receiverRank = Vexcty.getPlugin().getConfig().get("playerdata." + msgtarget.getUniqueId() + ".rank");
            Object targetRank = Vexcty.getPlugin().getConfig().get("playerdata." + msgsender.getUniqueId() + ".rank");
            ...
            if (Vexcty.getPlugin().getConfig().contains("playerdata." + msgtarget.getUniqueId() + ".rank")) {
